                    ...
                    <div className="container mx-auto px-3 sm:px-4 py-4 sm:py-6">
                        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 sm:gap-6">
                            <div>
                                ...
                                <p className="text-xs sm:text-sm text-gray-600 mt-1">Your saved favorite decorations</p>
                            </div>
                            <div className="flex items-center gap-3">
                                <div className="p-2 sm:p-3 bg-amber-100 rounded-full">
                                    <svg className="w-5 h-5 sm:w-6 sm:h-6 text-amber-600" fill="currentColor" viewBox="0 0 24 24">
                                        <path d="M12 21.35l-1.45-1.32C5.4 15.36 2 12.28 2 8.5 2 5.42 4.42 3 7.5 3c1.74 0 3.41.81 4.5 2.09C13.09 3.81 14.76 3 16.5 3 19.58 3 22 5.42 22 8.5c0 3.78-3.4 6.86-8.55 11.54L12 21.35z" />
                                    </svg>
                                </div>
                                <div>
                                    <div className="text-base sm:text-lg md:text-xl font-bold text-gray-900">{wishlistItems.length} items</div>
                    ...
                    {filteredItems.length === 0 ? (
                        <div className="text-center py-8 sm:py-12">
                            <div className="w-14 h-14 sm:w-16 sm:h-16 md:w-20 md:h-20 mx-auto mb-4 sm:mb-6 rounded-full bg-amber-100 flex items-center justify-center">
                                <svg className="w-7 h-7 sm:w-8 sm:h-8 md:w-10 md:h-10 text-amber-500" fill="currentColor" viewBox="0 0 24 24">
                                    <path d="M12 21.35l-1.45-1.32C5.4 15.36 2 12.28 2 8.5 2 5.42 4.42 3 7.5 3c1.74 0 3.41.81 4.5 2.09C13.09 3.81 14.76 3 16.5 3 19.58 3 22 5.42 22 8.5c0 3.78-3.4 6.86-8.55 11.54L12 21.35z" />
                                </svg>
                            </div>
                            <h3 className="text-lg sm:text-xl md:text-2xl font-bold text-gray-900 mb-2 sm:mb-3">Your wishlist is empty</h3>
                        ...
                        <>
                            ...
                            <div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-2 sm:gap-3 md:gap-4 lg:gap-6">
                                {filteredItems.map((item) => (
                                    <div key={item.id} className="group bg-white rounded-lg sm:rounded-xl shadow-sm border border-gray-200 hover:border-amber-300 hover:shadow-md transition-all duration-300 overflow-hidden">
                                        {/* Product Image */}
                                        <div className="relative h-32 sm:h-40 md:h-48 overflow-hidden">
                                            ...
                                            <button
                                                ...
                                                className="absolute top-2 right-2 p-1.5 sm:p-2 bg-white/90 backdrop-blur-sm rounded-full text-gray-500 hover:text-red-500 hover:bg-red-50 transition-colors shadow-sm"
                                            >
                                            ...
                                            {/* Stock Status */}
                                            {!item.inStock && (
                                                <div className="absolute bottom-2 left-2 right-2 px-2 py-1 sm:px-3 sm:py-1.5 bg-red-500/90 backdrop-blur-sm text-white text-xs font-medium rounded-full text-center">
                                                    Out of Stock
                                                </div>
                                            )}
                                            ...
                                            <div className="absolute inset-0 bg-black/40 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-center justify-center">
                                                <button
                                                    ...
                                                    className="px-3 py-1.5 sm:px-4 sm:py-2 bg-white text-gray-900 rounded-lg font-medium transform translate-y-4 group-hover:translate-y-0 transition-transform duration-300 text-xs sm:text-sm"
                                                >
                                                    Quick View
                                                </button>
                                            </div>
                                        ...
                                        <div className="p-2 sm:p-3 md:p-4">
                                            ...
                                            <div className="flex items-center justify-between mb-1.5 sm:mb-2">
                                                <span className="text-xs font-medium text-amber-600 bg-amber-50 px-1.5 py-0.5 sm:px-2 sm:py-1 rounded">
                                                    {item.category}
                                                </span>
                                            ...
                                            {/* Product Name */}
                                            <h3 className="font-semibold text-gray-900 mb-1.5 sm:mb-2 line-clamp-2 text-sm sm:text-base h-8 sm:h-10 md:h-12">
                                                {item.name}
                                            </h3>
                                            ...
                                            <div className="flex items-center gap-1.5 sm:gap-2 mb-2 sm:mb-3">
                                                <div className="flex items-center">
                                                    {[...Array(5)].map((_, i) => (
                                                        <svg
                                                            key={i}
                                                            className={`w-3 h-3 sm:w-3.5 sm:h-3.5 ${i < Math.floor(item.rating) ? 'text-amber-400' : 'text-gray-300'}`}
                                                            fill="currentColor"
                                                            viewBox="0 0 20 20"
                                                        >
                                            ...
                                            <div className="flex items-center justify-between mb-3 sm:mb-4">
                                                <div>
                                                    <div className="text-base sm:text-lg font-bold text-gray-900">₹{item.price}</div>
                                            ...
                                            <div className="flex gap-1.5 sm:gap-2">
                                                <button
                                                    ...
                                                    className={`flex-1 py-1.5 sm:py-2 md:py-2.5 rounded-lg font-medium transition-all duration-200 text-xs sm:text-sm ${!item.inStock
                                                ...
                                                <button
                                                    onClick={() => navigate(`/product/${item.id}`)}
                                                    className="px-2 sm:px-3 py-1.5 sm:py-2 md:py-2.5 border border-gray-300 hover:border-amber-300 text-gray-700 hover:text-amber-700 rounded-lg font-medium transition-colors text-xs sm:text-sm"
                                                >
                                                    View
                                                </button>
                                            </div>
                    ...
                    {wishlistItems.length === 0 && (
                        <div className="mt-8 sm:mt-12 max-w-3xl mx-auto">
                            <div className="bg-white rounded-lg sm:rounded-xl shadow-sm border border-gray-200 p-4 sm:p-6 md:p-8">
                                <h3 className="text-base sm:text-lg font-bold text-gray-900 mb-4 sm:mb-6 text-center">How to use Wishlist</h3>
                                <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-4">
                                    <div className="text-center p-3 sm:p-4">
                                        ...
                                        <h4 className="font-medium text-gray-900 mb-1 sm:mb-2 text-sm sm:text-base">Save Items</h4>
                                    ...
                                    <div className="text-center p-3 sm:p-4">
                                        ...
                                        <h4 className="font-medium text-gray-900 mb-1 sm:mb-2 text-sm sm:text-base">Track Products</h4>
                                        <p className="text-xs text-gray-600">
                                    ...
                                    <div className="text-center p-3 sm:p-4">
                                        ...
                                        <h4 className="font-medium text-gray-900 mb-1 sm:mb-2 text-sm sm:text-base">Easy Purchase</h4>
                                        <p className="text-xs text-gray-600">
